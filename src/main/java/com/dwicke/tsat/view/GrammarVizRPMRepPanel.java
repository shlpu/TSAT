...
import com.dwicke.tsat.view.table.RPMRepTableColumns;
import com.dwicke.tsat.view.table.RPMRepTableModel;
...
public class GrammarVizRPMRepPanel  extends JPanel implements ListSelectionListener {
    ...
    private com.dwicke.tsat.view.table.RPMRepTableModel RPMRepTableModel;
