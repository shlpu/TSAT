...
public class GrammarVizView implements Observer, ActionListener {
  ...
  private static final String APPLICATION_MOTTO = "Time Series Analysis Tool: TSAT";
  ...
  private void buildMenuBar() {
    ...
    // an exit item
    JMenuItem optionsItem = new JMenuItem("TSAT options", KeyEvent.VK_P);
  ...
  private void buildSequiturPane() {
    ...
    tabbedRulesPane.addTab("TSAT anomalies", null, anomaliesPane,
  ...
  private void buildLogPane() {
    ...
    log(Level.INFO, "running Time Series Analysis Tool: TSAT demo");
  }
