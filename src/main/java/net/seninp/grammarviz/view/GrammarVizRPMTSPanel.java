...
import net.seninp.grammarviz.view.table.RPMTSTableColumns;
import net.seninp.grammarviz.view.table.RPMTSTableModel;
...
public class GrammarVizRPMTSPanel extends JPanel implements ListSelectionListener {
    ...
    private RPMTSTableModel RPMTSTableModel;
